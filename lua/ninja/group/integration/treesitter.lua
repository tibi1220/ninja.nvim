...
function M.get(p)
  ...
  return {
    ...
    -- Types
    ["@type"]                   = { fg = p.lYellow }, -- For types.
    ["@type.builtin"]           = { fg = p.lYellow }, -- For builtin types.
    ...
    -- Identifiers
    -- ["@variable"]               = { fg = p.dYellow }, -- Any variable name that does not have another highlighC.
    -- ["@variable.builtin"]       = { fg = p.dYellow }, -- Variable names that are defined by the languages, like this or self.
